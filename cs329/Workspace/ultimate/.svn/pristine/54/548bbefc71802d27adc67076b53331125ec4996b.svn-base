...
/**
 * Tests cases for the methods in the ExactlyFiveInARowWinCondition class
 * 
 * @author ms5976
 */
public class ExactlyFiveInARowWinConditionTest {
	...
	public void setUp () throws Exception {
		...
		condition_ = new ExactlyFiveInARowWinCondition(board_);
	}
	...
	/**
	 * Test to make sure that 6 in a row in a row does not work
	 */
	@Test
	public void testSixInARowRowDoesNotWin () {
		board_.placePiece(player_,1,0);
		board_.placePiece(player_,2,0);
		board_.placePiece(player_,3,0);
		board_.placePiece(player_,4,0);
		board_.placePiece(player_,5,0);
		board_.placePiece(player_,6,0);
		assertFalse(condition_.checkCondition(player_));
	}

	/**
	 * Test to make sure that 6 in a row in a column does not work
	 */
	@Test
	public void testSixInARowColDoesNotWin () {
		board_.placePiece(player_,0,0);
		board_.placePiece(player_,0,1);
		board_.placePiece(player_,0,2);
		board_.placePiece(player_,0,3);
		board_.placePiece(player_,0,4);
		board_.placePiece(player_,0,5);
		assertFalse(condition_.checkCondition(player_));
	}

	/**
	 * Test to make sure that 6 in a row diagonally does not work
	 */
	@Test
	public void testSixInARowDiagDoesNotWin () {
		board_.placePiece(player_,0,0);
		board_.placePiece(player_,1,1);
		board_.placePiece(player_,2,2);
		board_.placePiece(player_,3,3);
		board_.placePiece(player_,4,4);
		board_.placePiece(player_,5,5);
