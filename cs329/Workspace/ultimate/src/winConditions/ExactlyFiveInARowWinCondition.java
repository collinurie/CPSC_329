...
/**
 * Class for the exact five in a row win condition
 * 
 * @author mb5053
 */
public class ExactlyFiveInARowWinCondition implements WinCondition {
	 ...
	 */
	public ExactlyFiveInARowWinCondition ( PenteBoard board ) {
		board_ = board;
	}
