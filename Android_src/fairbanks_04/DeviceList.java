...
public class DeviceList extends Activity {
            ...
            public void onClick(View v) {
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        Toast.makeText(DeviceList.this, "Connecting to: "+ item.getTitle() , Toast.LENGTH_SHORT).show();
                        ...
                        if(MainActivity.calibrate){
                            Intent myIntent = new Intent(DeviceList.this, CalibrateOne.class);
     ...
     * @return the device that is selected from the list
     */
